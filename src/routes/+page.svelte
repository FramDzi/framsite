...
<div class="caixadepagina-container">
	{#each paginas as paginatitle}
		<a href="{base}/{paginatitle}">
			<div class="caixadepagina">
...
<style>
	:global(body) {
		background-image: linear-gradient(to bottom right, rgb(53, 53, 53), rgb(126, 146, 200));
	}
